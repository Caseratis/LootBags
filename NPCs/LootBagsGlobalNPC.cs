...
namespace LootBags.NPCs
{
	public class LootBagsGlobalNPC : GlobalNPC
	{
        ...
        public override void NPCLoot(NPC npc)
		{
			...
			if (!Config.AllLootBagsDrop)
			{
				if (npc.lifeMax > 5 && npc.value > 0f && NPC.downedMoonlord)
				{
					Random random = new Random();
					int num = Main.rand.Next(0, Config.LootBag6DropChance);
					if (num == 0)
					{
				...
				{
					Random random = new Random();
					int num2 = Main.rand.Next(0, Config.LootBag5DropChance);
					if (num2 == 0)
					{
				...
				{
					Random random = new Random();
					int num3 = Main.rand.Next(0, Config.LootBag4DropChance);
					if (num3 == 0)
					{
				...
				{
					Random random = new Random();
					int num4 = Main.rand.Next(0, Config.LootBag3DropChance);
					if (num4 == 0)
					{
				...
				{
					Random random = new Random();
					int num5 = Main.rand.Next(0, Config.LootBag2DropChance);
					if (num5 == 0)
					{
				...
				{
					Random random = new Random();
					int num6 = Main.rand.Next(0, Config.LootBag1DropChance);
					if (num6 == 0)
					{
			...
			else if (Config.AllLootBagsDrop)
			{
				if (npc.lifeMax > 5 && npc.value > 0f && NPC.downedMoonlord)
				{
					Random random = new Random();
			...
			{
				Random random = new Random();
				int num7 = Main.rand.Next(0, Config.DyeBagDropChance);
				if (num7 == 0)
				{
