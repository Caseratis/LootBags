...
{
    public class GodlySword : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Godly Sword");
            Tooltip.SetDefault("Tier 6 Sword" + Environment.NewLine + "Explosions linger");  //The (English) text shown below your weapon's name
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.value = Item.buyPrice(gold: 25);           //The value of the weapon
            item.rare = 11;              //The rarity of the weapon, from -1 to 13
            item.UseSound = SoundID.Item1;      //The sound when the weapon is using
            item.autoReuse = true;          //Whether the weapon can use automatically by pressing mousebutton
            item.shoot = mod.ProjectileType("GodlySwordProj");
